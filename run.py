...
def get_sales_data():
    ...
    while True:
        ...
        # validate_data(sales_data) moved to if statement below
...
def calculate_surplus_data(sales_row):
    ...
    surplus_data = []
    # zip method iterates through two or more lists at the same time
...
def get_last_5_entries_sales():
    ...
    """
    sales = SHEET.worksheet("sales")
    # column = sales.col_values(3) #access the 3rd column by using this method
    # print(column)
    ...
    for ind in range(1, 7):
        ...
        columns.append(column[-5:]) # slices last 5 items and appends
    # pprint(columns)
    return columns
...
def calculate_stock_data(data):
    ...
    for column in data:
        ...
        average = sum(int_column) / len(int_column)  # average is sum of our values divided by the number of values
        stock_num = average * 1.1 # adds 10%
        new_stock_data.append(round(stock_num)) # rounds the numbers to nearest whole number and appends
